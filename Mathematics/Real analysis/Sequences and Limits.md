...
**Definition: (Convergence limit)** A sequence $\{a_n\}_{n=1}^\infty$ _converges_ to a real number $A$ iff for each $\epsilon>0$ there exists a positive integer $N$ such that for all $n>N$ we have $|a_n-A|< \epsilon$. ^d3b97d
