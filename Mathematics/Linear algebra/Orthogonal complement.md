...
The row-space is the orthogonal complement of the null-space of a matrix; that is, $\text{row}(A)=\text{null}(A)^{\perp}$. The following theorem restates this fact.
